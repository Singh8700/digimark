        ...
        <div className="footer1-content">
          ...
          <div className="footer1-links">
            ...
            <div className="footer1-column2">
              ...
              <a href="https://bit.ly/rohit-port" traget="__blank" style={{color:"black"}}>
                ...
                <a href="https://techsolvingveryesay.blogspot.com" traget="__blank" style={{color:"black"}}>
            ...
            <div className="footer1-column3">
              ...
              <div className="footer1-social-links">
                <div className="footer1-link">
                  ...
                  <a href='https://www.facebook.com/share/oUfuu7MNHbr22Le2/?mibextid=qi2Omg' target='__balnk' style={{color:"black"}}>
                ...
                <div className="footer1-link1">
                  ...
                  <a href='https://instagram.com/singh87_rohit' target='__balnk' style={{color:"black"}}>
